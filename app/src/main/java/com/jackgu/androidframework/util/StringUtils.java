...
public class StringUtils {
    ...
    public static SpannableString textSizeMore(SpannableString spannableString, int start, int
        ...
        spannableString.setSpan(new AbsoluteSizeSpan(DensityUtil.sp2px(MyApplication
    ...
    public static SpannableString textSizeMore(String str, int start, int end, int size) {
        SpannableString spannableString = new SpannableString(str);
        spannableString.setSpan(new AbsoluteSizeSpan(DensityUtil.sp2px(MyApplication.getApplication
                        (), size)), start, end,
                Spannable.SPAN_INCLUSIVE_EXCLUSIVE);
